...
{
    public class Menu2Memory : ModMenu
    {
        public class Cinder
        {
            public int Time;
        ...
        public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("UnCalamityModMusic/Content/Menus/MemoryLogo");
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("UnCalamityModMusic/Content/Menus/MemoryBackground").Value;
            ...
            {
                return Color.Lerp(Color.Lerp(Color.LightGray, Color.LightCyan, 0.3f), Color.Lerp(Color.Cyan, Color.Gold, Main.rand.NextFloat()), Main.rand.NextFloat());
            }
