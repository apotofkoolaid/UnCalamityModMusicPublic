...
{
    public class Menu1Resurrection : ModMenu
    {
        public class Cinder
        {
            public int Time;
        ...
        public override Asset<Texture2D> Logo => ModContent.Request<Texture2D>("UnCalamityModMusic/Content/Menus/ResurrectionLogo");
        ...
        {
            Texture2D texture = ModContent.Request<Texture2D>("UnCalamityModMusic/Content/Menus/ResurrectionBackground").Value;
            ...
            {
                return Color.Lerp(Color.Lerp(Color.DarkBlue, Color.LightCyan, 0.3f), Color.Lerp(Color.Turquoise, Color.LimeGreen, Main.rand.NextFloat()), Main.rand.NextFloat());
            }
